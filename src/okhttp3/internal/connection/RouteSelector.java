...
public final class RouteSelector {
	...
	public Route next() throws IOException {
		...
		if (routeDatabase.shouldPostpone(route)) {
			...
			// We will only recurse in order to skip previously failed routes.
	...
	/**
	 * Obtain a "host" from an {@link InetSocketAddress}. This returns a string
	 * containing either an actual host name or a numeric IP address.
	 */
	// Visible for testing
	...
	private InetSocketAddress nextInetSocketAddress() throws IOException {
		if (!hasNextInetSocketAddress()) {
			throw new SocketException("No route to " + address.url().host() + "; exhausted inet socket addresses: "
					+ inetSocketAddresses);
		}
