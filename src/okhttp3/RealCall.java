...
final class RealCall implements Call {
	...
	private String toLoggableString() {
		String string = retryAndFollowUpInterceptor.isCanceled() ? "canceled call"
				: "call";
	...
	private Response getResponseWithInterceptorChain() throws IOException {
		...
		Interceptor.Chain chain = new RealInterceptorChain(interceptors, null,
				null, null, 0, originalRequest);
		// 这里是proceed执行的源头。最终的Response在这里返回-RealInterceptorChain中的proceed方法
